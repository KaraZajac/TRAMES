...
surveillance costs about ninety seconds. This figure is conditional on the assumed camera
...
\midrule
\SI{30}{\metre} & \num{3.57} & \num{0.75}$\times$ & \SI{87.0}{\percent} & \SI{5.8}{\percent} \\
\SI{45}{\metre} & \num{4.31} & \num{0.91}$\times$ & \SI{85.6}{\percent} & \SI{5.6}{\percent} \\
\SI{60}{\metre} & \num{4.75} & assumed            & \SI{84.3}{\percent} & \SI{5.6}{\percent} \\
\SI{90}{\metre} & \num{5.32} & \num{1.12}$\times$ & \textbf{\SI{56.5}{\percent}} & \SI{21.0}{\percent} \\
\bottomrule
\end{tabular}
\end{table}
...
falls from \SI{84.3}{\percent} to \SI{56.5}{\percent}, a drop of \num{27.8} points
(\SI{95}{\percent} CI $[-28.5, -27.1]$), and residual exposure quadruples from
\SI{5.6}{\percent} to \SI{21.0}{\percent} of baseline. If real fields of view are half again
as long as we assume, roughly a third of the routes this paper counts as clean are not.
