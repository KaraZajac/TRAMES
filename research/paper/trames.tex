...
\noindent
The \SI{18}{\giga\byte} OSM extract, the \SI{14}{\giga\byte} graph caches and the
\SI{163}{\giga\byte} OSM full-history dump are not redistributed; the acquisition and
import scripts rebuild all of them. Commuter weights come from
